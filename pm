...
seqfile <- seq.low <- seq.high <- treefile <- classfile <- NULL
...
if(!is.null(seqfile)) {
  count <- seqCount(seqfile); Log(paste("Number of sequences:",count[1],";","Number of sites:",count[2]))
}
if(!is.null(seq.high)) {
  count <- seqCount(seq.high); Log(paste("HIGH PARTITION -- Number of sequences:",count[1],";","Number of sites:",count[2]))
}
if(!is.null(seq.low)) {
  count <- seqCount(seq.high); Log(paste("LOW PARTITION -- Number of sequences:",count[1],";","Number of sites:",count[2]))
}
